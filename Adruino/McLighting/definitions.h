...
uint32_t autoParams[][6] = {   // main_color, back_color, xtra_color, speed, mode, duration (seconds)
  {0x00ff0000, 0x0000ff00, 0x00000000, 200,  1,  5}, // blink red/geen for 5 seconds
  {0x0000ff00, 0x000000ff, 0x00000000, 200,  3, 10}, // wipe green/blue for 10 seconds
  {0x000000ff, 0x00ff0000, 0x00000000,  60, 14, 10}, // dual scan blue on red for 10 seconds
  {0x000000ff, 0x00ff0000, 0x00000000,  40, 45, 15}, // fireworks blue/red for 15 seconds
  {0x00ff0000, 0x0000ff00, 0x000000ff,  40, 54, 15}  // tricolor chase red/green/blue for 15 seconds
};
